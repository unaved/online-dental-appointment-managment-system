...
const SignInForm = ({page}) => {
    const [isSignUp, setSignUp] = useState(page);
            ...
            <div className="panels-container">
                <div className="panel left-panel">
                    <div className="content">
                        ...
                        <button className="iBtn transparent" onClick={() => {setSignUp(true); navigate('/sign-up')}}>Sign Up</button>
                    </div>
                ...
                <div className="panel right-panel">
                    <div className="content">
                        <h3>One of us ?</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi beatae quas magnam!</p>
                        <button className="iBtn transparent" onClick={() => {setSignUp(false);  navigate('/sign-in')}}>Sign In</button>
                    </div>
