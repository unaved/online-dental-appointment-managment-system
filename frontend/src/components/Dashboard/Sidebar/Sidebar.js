...
const Sidebar = () => {
    ...
    return (
        <div className="sidebar d-flex flex-column col-2 py-5">
            <ul className="list-unstyled">
                ...
                {user.isAdmin &&
                    ...
                    <li>
                        ...
                        <li>
                            <Link to="/services" className="text-nowrap text-white text-decoration-none"><FontAwesomeIcon icon={faUserPlus} />
                                <span>Services</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="/enquiry" className="text-nowrap text-white text-decoration-none"><FontAwesomeIcon icon={faUserPlus} />
                                <span>Enquiry</span>
                            </Link>
                        </li>
                    </>
